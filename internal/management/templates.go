        ...
        <main id="appShell">
            ...
            <section id="overviewPanel">
                ...
                <div class="section card">
                    ...
                    <p class="yaml-hint" data-i18n="pacingTableHint">展示最近一次排序中每个凭证的配速富余度（remaining_headroom）。它直接驱动调度权重；0 表示没有配速富余而非不参与流量，数值可超过 1.0。</p>
                        ...
                        <table class="pacing-table">
                            <thead>
                                <tr>
                                    ...
                                    <th data-i18n="colRemainingHeadroom">配速富余度</th>
