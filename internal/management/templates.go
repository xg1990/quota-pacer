        ...
        <main id="appShell">
            ...
            <section id="overviewPanel">
                ...
                <div class="section card">
                    ...
                    <p class="yaml-hint" data-i18n="pacingTableHint">展示最近一次排序时每个凭证的剩余额度、重置窗口与最终配速富余度（headroom）计算结果，用于理解排序依据。</p>
